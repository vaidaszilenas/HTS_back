...
class KlaipedaController extends Controller
{
    /**
     ...
     */
     ...
     public function store(Request $request)
     {
       ...
       // var_dump($post);
       Klaipeda::create($post);
       $post = $request->except('_token');
       // var_dump($post);

       return redirect()->route('klaipeda');
     }
     ...
     public function show($id)
     {
       ...
       $utena = Klaipeda::where('id', $id)->firstOrFail();

       return View::make('show-klaipeda')->with('utena', $utena);
