...
class KaunasController extends Controller
{
    /**
     ...
     */
     ...
     public function show($id)
     {
       ...
       $utena = Kaunas::where('id', $id)->firstOrFail();

       return View::make('show-kaunas')->with('utena', $utena);
