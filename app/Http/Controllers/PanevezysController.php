...
class PanevezysController extends Controller
{
    /**
     ...
     */
     ...
     public function store(Request $request)
     {
       ...
       // var_dump($post);
       Panevezys::create($post);
       $post = $request->except('_token');
       // var_dump($post);

       return redirect()->route('panevezys');
     }
     ...
     public function show($id)
     {
       ...
       $utena = Panevezys::where('id', $id)->firstOrFail();

       return View::make('show-panevezys')->with('utena', $utena);
