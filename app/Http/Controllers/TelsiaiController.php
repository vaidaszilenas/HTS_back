...
class TelsiaiController extends Controller
{
    /**
     ...
     */
     ...
     public function show($id)
     {
       ...
       $utena = Telsiai::where('id', $id)->firstOrFail();

       return View::make('show-telsiai')->with('utena', $utena);
