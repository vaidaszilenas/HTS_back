...
class SiauliaiController extends Controller
{
    /**
     ...
     */
     ...
     public function store(Request $request)
     {
       ...
       // var_dump($post);
       Siauliai::create($post);
       $post = $request->except('_token');
       // var_dump($post);

       return redirect()->route('siauliai');
     }
     ...
     public function show($id)
     {
       ...
       $utena = Siauliai::where('id', $id)->firstOrFail();

       return View::make('show-siauliai')->with('utena', $utena);
