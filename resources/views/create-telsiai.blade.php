...
<div class="container">
  <div class="row justify-content-center">
    <form class="form-horizontal" method="post" action="{{route('telsiai-store')}}" enctype="multipart/form-data">
      {!!csrf_field() !!}
      ...
      <div class="form-group">
        ...
        <div class="col-sm-10">
          <select class="form-control" name="district">
            <option value="Telšių rajonas">Telšių raj.</option>
            <option value="Rietavo savivaldybė">Rietavo sav.</option>
            <option value="Plungės rajonas">Plungės raj.</option>
            <option value="Mažeikių rajonas">Mažeikių raj.</option>
          </select>
        </div>
      </div>
      ...
      <a href="{{'/county-telsiai'}}" class="btn btn-danger float-left ml-1">
        Grįžti
      </a>
