...
<div class="container">
  <div class="row justify-content-center">
    <form class="form-horizontal" method="post" action="{{route('vilnius-store')}}" enctype="multipart/form-data">
      {!!csrf_field() !!}
      ...
      <a href="{{'/county-vilnius'}}" class="btn btn-danger float-left ml-1">
        Grįžti
      </a>
