...
@section('content')
  <section>
    <div class="section-container">
      <h1 class="mb-2">Marijampolės apskritis</h1>
      <div class="row">
        ...
        <div class="col-3 col-sm-4">
          <div class="section-border">
            ...
            <a href="{{route('show-marijampole', $hts->id)}}">  <img src="{{$hts->getUrlAttribute()}}" alt="" class="img-thumbnail"></a>
            ...
            @if (Auth::user()->isAdmin())
              <form class="" action="{{route('destroy-marijampole', $hts->id)}}" method="post" style="display: inline-block;">
                {{ csrf_field() }}
                {{-- {{ method_field('delete') }} --}}
    ...
    @if (Auth::check())
    @if (Auth::user()->isAdmin())
    <a href="{{'/create-marijampole'}}" class="btn btn-success btn-sm float-left mr-2 mt-4 mb-4">Sukurti naują HTS statinį</a>
  @endif
  @endif
  </section>
